...
struct LobbyView: View {
    ...
    @State private var showWordPacksSheet = false
    ...
    var body: some View {
            ...
            VStack(spacing: 20) {
                HStack(spacing: 12) {
                    LobbyQuickActionButton(
                        title: "Word Packs",
                        subtitle: viewModel.selectedWordPackSummary,
                        systemImage: "books.vertical.fill"
                    ) {
                        showWordPacksSheet = true
                    }
        ...
        .sheet(isPresented: $showWordPacksSheet) {
            wordPacksSheet
        }
    ...
    private var wordPacksSheet: some View {
        NavigationStack {
            ZStack {
    ...
    private var rulesSettingsCard: some View {
        SettingsCard {
            SettingsToggleRow(
